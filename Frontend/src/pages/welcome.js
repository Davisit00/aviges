      ...
      <div class="cards-grid">
        ...
        <div class="info-card card-procesos">
          <h2 style="color: #003B73;">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24"><path fill="#003B73" fill-rule="evenodd" d="M3 3a3 3 0 0 0-3 3v9c0 1.312.842 2.427 2.016 2.835A3.5 3.5 0 0 0 8.965 18h6.07a3.501 3.501 0 0 0 6.95-.165A3 3 0 0 0 24 15v-4.248a3 3 0 0 0-.742-1.976L20.85 6.024A3 3 0 0 0 18.592 5H16.83A3 3 0 0 0 14 3zm1 14.436v.128a1.501 1.501 0 0 0 3 0v-.128a1.501 1.501 0 0 0-3 0M5.5 14a3.5 3.5 0 0 1 3.163 2h6.674a3.5 3.5 0 0 1 6.235-.18A1 1 0 0 0 22 15v-4h-5a2 2 0 0 1-2-2V6a1 1 0 0 0-1-1H3a1 1 0 0 0-1 1v9c0 .34.17.64.428.82A3.5 3.5 0 0 1 5.5 14M17 7v1a1 1 0 0 0 1 1h2.796l-1.451-1.659A1 1 0 0 0 18.593 7zm0 10.436v.128a1.501 1.501 0 0 0 3 0v-.128a1.501 1.501 0 0 0-3 0" clip-rule="evenodd"/></svg> 
            Procesos
          </h2>
          <p>
        ...
        <div class="info-card card-mantenimiento">
          <h2 style="color: #FFB801;">
            <svg xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-width="1.5" style="display: block; width: 28px; height: 28px;" fill="none" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 1 1-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 0 0 4.486-6.336l-3.276 3.277a3 3 0 0 1-2.25-2.25l3.276-3.276a4.5 4.5 0 0 0-6.336 4.486c.091 1.076-.071 2.264-.904 2.95l-.102.085m-1.745 1.437L5.909 7.5H4.5L2.25 3.75l1.5-1.5L7.5 4.5v1.409l4.26 4.26m-1.745 1.437 1.745-1.437m6.615 8.206L15.75 15.75M4.867 19.125h.008v.008h-.008z" /></svg> 
            Mantenimiento
          </h2>
          <p>
            <strong>¿Qué hago aquí?</strong><br>
            Aquí registras la información maestra (datos fijos) para agilizar los procesos.
          </p>
          <p>
            Sirve para guardar:
            <br>• Nombres de choferes.
            <br>• Placas de vehículos.
            <br>• Tipos de productos (Alimentos).
        ...
        <div class="info-card card-reportes">
          <h2 style="color: #ED1C24;">
            <svg style="width: 28px; height: 28px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor"><path d="M15 20h2v4h-2zm5-2h2v6h-2zm-10-4h2v10h-2z" /><path d="M25 5h-3V4a2 2 0 0 0-2-2h-8a2 2 0 0 0-2 2v1H7a2 2 0 0 0-2 2v21a2 2 0 0 0 2 2h18a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2M12 4h8v4h-8Zm13 24H7V7h3v3h12V7h3Z" /><path d="M0 0h32v32H0z" style="fill:none" /></svg>
            Reportes
          </h2>
          <p>
            <strong>¿Qué hago aquí?</strong><br>
            Esta sección funciona como el historial y auditoría.
          </p>
          <ul style="padding-left: 20px; color: #555;">
            <li>Buscar tickets antiguos por fecha o placa.</li>
            <li>Reimprimir tickets finalizados.</li>
            <li>Ver listado completo de pesajes realizados.</li>
          </ul>
        </div>
